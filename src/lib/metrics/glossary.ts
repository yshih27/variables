...
export const METRICS = {
  ...
  // The outbound leg is a GROSS WALLET FLOW; only the R3-counted subset of it is
  // a player payout. These terms have to carry that distinction, because the
  // numbers themselves cannot. See docs/roadmap/net-gacha-reconciliation.md §5
  // and Addendum A.
  //
  // ⚠️ `netGachaRevenue` is defined again as of the R3 lift (Addendum A §A7) —
  // but only Collector Crypt renders it. Phygitals stays held: R3 left its payout
  ...
  buybackRate: {
    term: "Buyback rate",
    text: "Gross outbound ÷ gacha spend over 30 complete days. R3-verified: 99%+ of outbound goes to player wallets — wallets that have themselves spent into this platform's gacha. Flows, not profit.",
  },
  partnerAttribution: {
    term: "Top partners",
