                ...
                {v.listings ? (
                  <>
                    ...
                    {v.floorUsd != null ? (
                      v.coverage === "native" ? (
                        <>
                          {" · "}floor <span className="tabular text-ink-2">{askText(v.floorUsd)}</span>
                        </>
                      ) : (
                        <>
                          {" · "}unverified ask <span className="tabular text-ink-3">{askText(v.floorUsd)}</span> · aggregator listing
                        </>
                      )
                    ) : null}
                  </>
