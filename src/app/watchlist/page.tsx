...
export const metadata = {
  ...
  description: "Your saved cards, IPs and platforms — reference prices, live volume, market cap and holders.",
};
      ...
      <div className="px-8 pt-8 pb-20 font-sans">
        <div className="mb-8">
          ...
          <p className="mt-2 max-w-xl text-[13.5px] leading-relaxed text-ink-3">
            The cards, IPs and platforms you follow, with their prices and live stats. Saved in this browser.
          </p>
        </div>
